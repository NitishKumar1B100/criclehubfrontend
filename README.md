<body>  
    ...
    <h2>Repositories</h2>
    <ul>
        <li>🟦 <strong>Frontend:</strong> <a href="https://github.com/your-username/circlehub" target="_blank">Frontend Repository</a></li>
        <li>🟨 <strong>Backend:</strong> <a href="https://github.com/NitishKumar1B100/ciclehubackend" target="_blank">Backend Repository</a></li>
    </ul>
    ...
    <p><strong>For Backend (repo link above):</strong></p>
    <p class="install-steps">  
        <code>git clone https://github.com/NitishKumar1B100/ciclehubackend</code><br>
        <code>cd ciclehubackend</code><br>
        <code>npm install</code>  
    </p>  
